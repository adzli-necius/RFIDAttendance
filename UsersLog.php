...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Rekod Kehadiran Pelajar</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Tapis Rekod/Export ke Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Tapis Rekod:</h3>
          ...
          <form method="POST" action="Export_Excel.php" enctype="multipart/form-data">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Tarikh:</div>
                      <div class="panel-body">
                      <label for="Start-Date"><b>Tarikh Mula:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Tarikh Akhir:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Waktu Masuk</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Waktu Keluar</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Masa Mula:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Masa Akhir:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Pengguna:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Kursus:</b></label>
            ...
            <div class="modal-footer">
              <button type="button" name="user_log" id="user_log" class="btn btn-success">Tapis</button>
