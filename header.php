...
<div class="header">
	<div class="logo">
		<a href="index.php">Sistem E-PLK</a>
...
<div class="topnav" id="myTopnav">
    ...
    <a href="ManageUsers.php">Urus Pengguna</a>
    <a href="UsersLog.php">Log Pengguna</a>
    <a href="devices.php">Peralatan</a>
    <?php  
    ...
    <div class="modal-content">
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	...
	      	<input type="text" name="up_name" placeholder="Masukkan nama anda..." value="<?php echo $_SESSION['Admin-name']; ?>" required/><br>
	      	<label for="User-mail"><b>Admin E-mail:</b></label>
	      	<input type="email" name="up_email" placeholder="Masukkan E-mel anda..." value="<?php echo $_SESSION['Admin-email']; ?>" required/><br>
	      	<label for="User-psw"><b>Password</b></label>
	      	<input type="password" name="up_pwd" placeholder="Masukkan Kata Laluan anda..." required/><br>
	      </div>
