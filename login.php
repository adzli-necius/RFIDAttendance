...
<main>
  <h1 class="slideInDown animated">Sila, log masuk dengan menggunakan email Admin dan Kata laluan Admin</h1>
  <h1 class="slideInDown animated" id="reset">Sila masukkan email anda untuk set semula kata laluan</h1>
<!-- Log In -->
<section>
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
          ...
          <p class="message">Terlupa Kata Laluan? <a href="#">Set Semula Kata laluan</a></p>
        </form>
      </div>
    </div>
  </div>
